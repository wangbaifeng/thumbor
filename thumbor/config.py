...
dictConfig = {
    ...
    'handlers': {
        ...
        'info_file_handler': {
            ...
            'formatter': 'standard',
            'filename': THUMBOR_LOG_PATH,  # join('/usr/src/app/log', 'fs-thumbor.log'),  # 输出位置
...
Config.define('THUMBOR_LOG_CONFIG', dictConfig, 'Logging configuration as json', 'Logging')
Config.define(
...
Config.define('ALLOWED_SOURCES', [], "Allowed domains for the http loader to download. These are regular expressions.",
              'Imaging')
...
Config.define('HEIF2JPEG_THREADS', 10, 'Convert a HEIF image to JPEG threads', 'Extensibility')
...
# FILE LOADER OPTIONS
Config.define('FILE_LOADER_ROOT_PATH', home, 'The root path where the File Loader will try to find images',
              'File Loader')
...
Config.define('MEMCACHE_STORAGE_SERVERS', ['localhost:11211'], 'List of Memcache storage server hosts',
              'Memcache Storage')
...
Config.define('REDIS_QUEUE_SERVER_HOST', 'localhost', 'Server host for the queued redis detector',
...
Config.define('REDIS_QUEUE_SERVER_DB', 0, 'Server database index for the queued redis detector',
              'Queued Redis Detector')
Config.define('REDIS_QUEUE_SERVER_PASSWORD', None, 'Server password for the queued redis detector',
              'Queued Redis Detector')
...
Config.define('ERROR_FILE_NAME_USE_CONTEXT', False, 'File of error log name is parametrized with context attribute',
              'Errors')
